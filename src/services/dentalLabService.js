...
const createWorkOrder = async (workOrderData) => {
    try {
        // Validate patient-tooth selection first
        ...
        console.log('Creating work order with user:', { userId, userRole });
        console.log('Patient-tooth selection:', formatPatientToothSummary(workOrderData.patient_name, workOrderData.tooth_numbers));
